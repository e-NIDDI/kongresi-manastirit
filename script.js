...
function initAlphabetGrid() {
    ...
    const info = {
        ...
        J:  { emri: "Jë",  shqiptim: "Jeeee",     shembuj: "ju, jam, jo" },
        K:  { emri: "Kë",   shqiptim: "Keeee",    shembuj: "kafshë, këngë, kurrë" },
        L:  { emri: "Lë",   shqiptim: "Lee",     shembuj: "lule, libër, lart" },
        Ll: { emri: "Ëll",  shqiptim: "llee",    shembuj: "llullë, llambë, mall" },
        M:  { emri: "Më",   shqiptim: "Meee",    shembuj: "mama, motër, mirë" },
        N:  { emri: "Në",   shqiptim: "Neee",     shembuj: "nënë, natë, nxit" },
